...
PROB_THRESHOLD = env_float("PROB_THRESHOLD", 0.54)
MAX_PROB_THRESHOLD = env_optional_float("MAX_PROB_THRESHOLD", 0.74)
MIN_EXPECTED_NET_R = env_float("MIN_EXPECTED_NET_R", 0.20)
...
SIDE_REGIME_GATES = {
    ("LONG", 0): _decision_gate("LONG_REGIME0", False, 0.58, 0.74, 0.28, 0.85),
    ...
    ("SHORT", 1): _decision_gate("SHORT_REGIME1", True, 0.54, 0.74, 0.20, 0.80),
}
...
CANDIDATE_SETUP_ENABLED = {
    ...
    "SHORT_REGIME1_STRONG_BOUNCE_REJECT": env_bool("SHORT_REGIME1_STRONG_BOUNCE_REJECT_ENABLED", True),
    "SHORT_REGIME1_FAILED_RECLAIM": env_bool("SHORT_REGIME1_FAILED_RECLAIM_ENABLED", True),
