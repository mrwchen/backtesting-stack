...
def create_run(conn, cfg: RunConfig, data_start_ts, data_end_ts, bars_total: int) -> int:
    columns = {
        ...
        "roll_vol_bars": cfg.roll_vol_bars,
        ...
        "hmm_covariance_type": cfg.hmm_covariance_type,
        "garch_p": cfg.garch_p,
        "garch_q": cfg.garch_q,
        ...
        "decision_gate_mode": cfg.decision_gate_mode,
        ...
        "trailing_activation_mult": cfg.trailing_activation_mult,
        "trailing_distance_mult": cfg.trailing_distance_mult,
        "min_stop_pct": cfg.min_stop_pct,
        "max_stop_pct": cfg.max_stop_pct,
        "max_hold_bars": cfg.max_hold_bars,
        "allow_short": cfg.allow_short,
        "reentry_cooldown_bars": cfg.reentry_cooldown_bars,
        "intrabar_fill_priority": cfg.intrabar_fill_priority,
