...
MARKET_REGIME_GUARD_ENABLED = env_bool("MARKET_REGIME_GUARD_ENABLED", False)
MARKET_REGIME_SYMBOL = env_str("MARKET_REGIME_SYMBOL", "QQQ").upper()
MARKET_REGIME_TZ = env_str("MARKET_REGIME_TZ", _account_setting("ENTRY_WINDOW_TZ", "America/New_York"))
MARKET_REGIME_LOOKBACK_DAYS = max(2, env_int("MARKET_REGIME_LOOKBACK_DAYS", 60))
MARKET_REGIME_MIN_HISTORY_DAYS = max(2, env_int("MARKET_REGIME_MIN_HISTORY_DAYS", 20))
MARKET_REGIME_ELEVATED_DRAWDOWN_PCT = env_float("MARKET_REGIME_ELEVATED_DRAWDOWN_PCT", 5.0)
MARKET_REGIME_HIGH_DRAWDOWN_PCT = env_float("MARKET_REGIME_HIGH_DRAWDOWN_PCT", 10.0)
MARKET_REGIME_EXTREME_DRAWDOWN_PCT = env_float("MARKET_REGIME_EXTREME_DRAWDOWN_PCT", 15.0)
MARKET_REGIME_MA_CONFIRM_ENABLED = env_bool("MARKET_REGIME_MA_CONFIRM_ENABLED", True)
MARKET_REGIME_MA_SHORT_DAYS = max(2, env_int("MARKET_REGIME_MA_SHORT_DAYS", 20))
MARKET_REGIME_MA_LONG_DAYS = max(2, env_int("MARKET_REGIME_MA_LONG_DAYS", 50))
MARKET_REGIME_MA_CONFIRM_TIER = env_int("MARKET_REGIME_MA_CONFIRM_TIER", 1)
MARKET_REGIME_LONG_RISK_MULTIPLIER_ELEVATED = env_float("MARKET_REGIME_LONG_RISK_MULTIPLIER_ELEVATED", 0.50)
MARKET_REGIME_LONG_RISK_MULTIPLIER_HIGH = env_float("MARKET_REGIME_LONG_RISK_MULTIPLIER_HIGH", 0.20)
MARKET_REGIME_LONG_RISK_MULTIPLIER_EXTREME = env_float("MARKET_REGIME_LONG_RISK_MULTIPLIER_EXTREME", 0.0)
MARKET_REGIME_MAX_LONG_POSITIONS_ELEVATED = env_int("MARKET_REGIME_MAX_LONG_POSITIONS_ELEVATED", _default_position_cap(0.30))
MARKET_REGIME_MAX_LONG_POSITIONS_HIGH = env_int("MARKET_REGIME_MAX_LONG_POSITIONS_HIGH", 1)
MARKET_REGIME_MAX_LONG_POSITIONS_EXTREME = env_int("MARKET_REGIME_MAX_LONG_POSITIONS_EXTREME", 0)
MARKET_REGIME_SHORT_HEDGE_ENABLED = env_bool("MARKET_REGIME_SHORT_HEDGE_ENABLED", True)
MARKET_REGIME_SHORT_HEDGE_MIN_TIER = env_int("MARKET_REGIME_SHORT_HEDGE_MIN_TIER", 1)
MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_ELEVATED = env_float("MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_ELEVATED", 0.50)
MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_HIGH = env_float("MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_HIGH", 0.75)
MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_EXTREME = env_float("MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_EXTREME", 1.0)
MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_ELEVATED = env_int("MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_ELEVATED", 1)
MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_HIGH = env_int("MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_HIGH", 2)
MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_EXTREME = env_int("MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_EXTREME", 3)
MARKET_REGIME_GENERATE_HEDGE_ENABLED = env_bool("MARKET_REGIME_GENERATE_HEDGE_ENABLED", False)
MARKET_REGIME_HEDGE_SYMBOL = env_str("MARKET_REGIME_HEDGE_SYMBOL", MARKET_REGIME_SYMBOL).upper()
MARKET_REGIME_HEDGE_MIN_TIER = env_int("MARKET_REGIME_HEDGE_MIN_TIER", MARKET_REGIME_SHORT_HEDGE_MIN_TIER)
MARKET_REGIME_HEDGE_INTENT_SCORE = env_float("MARKET_REGIME_HEDGE_INTENT_SCORE", 100.0)
MARKET_REGIME_HEDGE_REQUIRE_BROKER_ELIGIBILITY = env_bool("MARKET_REGIME_HEDGE_REQUIRE_BROKER_ELIGIBILITY", False)
MARKET_REGIME_HEDGE_ALLOW_MULTIPLE_POSITIONS = env_bool("MARKET_REGIME_HEDGE_ALLOW_MULTIPLE_POSITIONS", False)

PORTFOLIO_DRAWDOWN_CIRCUIT_BREAKER_ENABLED = env_bool("PORTFOLIO_DRAWDOWN_CIRCUIT_BREAKER_ENABLED", False)
PORTFOLIO_DRAWDOWN_WARN_PCT = env_float("PORTFOLIO_DRAWDOWN_WARN_PCT", 6.0)
PORTFOLIO_DRAWDOWN_STRESS_PCT = env_float("PORTFOLIO_DRAWDOWN_STRESS_PCT", 10.0)
PORTFOLIO_DRAWDOWN_EXTREME_PCT = env_float("PORTFOLIO_DRAWDOWN_EXTREME_PCT", 15.0)
PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_WARN = env_float("PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_WARN", 0.50)
PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_STRESS = env_float("PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_STRESS", 0.20)
PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_EXTREME = env_float("PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_EXTREME", 0.0)
PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_WARN = env_int("PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_WARN", _default_position_cap(0.30))
PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_STRESS = env_int("PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_STRESS", 1)
PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_EXTREME = env_int("PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_EXTREME", 0)
PORTFOLIO_DRAWDOWN_RESET_ON_REGIME_ENABLED = env_bool("PORTFOLIO_DRAWDOWN_RESET_ON_REGIME_ENABLED", False)
PORTFOLIO_DRAWDOWN_RESET_REGIME_LABEL = os.getenv("PORTFOLIO_DRAWDOWN_RESET_REGIME_LABEL", "CONSTRUCTIVE").strip().upper()
PORTFOLIO_DRAWDOWN_RESET_CONSECUTIVE_DAYS = max(1, env_int("PORTFOLIO_DRAWDOWN_RESET_CONSECUTIVE_DAYS", 4))
...
if not (0.0 < MARKET_REGIME_ELEVATED_DRAWDOWN_PCT < MARKET_REGIME_HIGH_DRAWDOWN_PCT < MARKET_REGIME_EXTREME_DRAWDOWN_PCT <= 100.0):
    raise ValueError(
        "MARKET_REGIME drawdown thresholds must satisfy 0 < ELEVATED < HIGH < EXTREME <= 100"
    )
if not (0 <= MARKET_REGIME_MA_CONFIRM_TIER <= 3):
    raise ValueError("MARKET_REGIME_MA_CONFIRM_TIER must be between 0 and 3")
if not (0 <= MARKET_REGIME_SHORT_HEDGE_MIN_TIER <= 3):
    raise ValueError("MARKET_REGIME_SHORT_HEDGE_MIN_TIER must be between 0 and 3")
if not (0 <= MARKET_REGIME_HEDGE_MIN_TIER <= 3):
    raise ValueError("MARKET_REGIME_HEDGE_MIN_TIER must be between 0 and 3")
if not (0.0 < PORTFOLIO_DRAWDOWN_WARN_PCT < PORTFOLIO_DRAWDOWN_STRESS_PCT < PORTFOLIO_DRAWDOWN_EXTREME_PCT <= 100.0):
    raise ValueError(
        "PORTFOLIO_DRAWDOWN thresholds must satisfy 0 < WARN < STRESS < EXTREME <= 100"
    )
if PORTFOLIO_DRAWDOWN_RESET_REGIME_LABEL not in REGIME_EXPOSURE_BY_LABEL:
    allowed = ", ".join(REGIME_EXPOSURE_BY_LABEL)
    raise ValueError(
        f"PORTFOLIO_DRAWDOWN_RESET_REGIME_LABEL must be one of: {allowed}"
    )
for _name, _value in {
    ...
    "MARKET_REGIME_LONG_RISK_MULTIPLIER_ELEVATED": MARKET_REGIME_LONG_RISK_MULTIPLIER_ELEVATED,
    "MARKET_REGIME_LONG_RISK_MULTIPLIER_HIGH": MARKET_REGIME_LONG_RISK_MULTIPLIER_HIGH,
    "MARKET_REGIME_LONG_RISK_MULTIPLIER_EXTREME": MARKET_REGIME_LONG_RISK_MULTIPLIER_EXTREME,
    "MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_ELEVATED": MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_ELEVATED,
    "MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_HIGH": MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_HIGH,
    "MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_EXTREME": MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_EXTREME,
    "MARKET_REGIME_HEDGE_INTENT_SCORE": MARKET_REGIME_HEDGE_INTENT_SCORE,
    "PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_WARN": PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_WARN,
    "PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_STRESS": PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_STRESS,
    "PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_EXTREME": PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_EXTREME,
}.items():
    if _value < 0.0:
        raise ValueError(f"{_name} must be >= 0")
for _name, _value in {
    ...
    "MARKET_REGIME_MAX_LONG_POSITIONS_ELEVATED": MARKET_REGIME_MAX_LONG_POSITIONS_ELEVATED,
    "MARKET_REGIME_MAX_LONG_POSITIONS_HIGH": MARKET_REGIME_MAX_LONG_POSITIONS_HIGH,
    "MARKET_REGIME_MAX_LONG_POSITIONS_EXTREME": MARKET_REGIME_MAX_LONG_POSITIONS_EXTREME,
    "MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_ELEVATED": MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_ELEVATED,
    "MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_HIGH": MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_HIGH,
    "MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_EXTREME": MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_EXTREME,
    "PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_WARN": PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_WARN,
    "PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_STRESS": PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_STRESS,
    "PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_EXTREME": PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_EXTREME,
}.items():
    if _value < 0:
        raise ValueError(f"{_name} must be >= 0")
for _name, _value in {
...
def _build_run_notes(notes: Optional[str], cfg=None) -> str:
    ...
    pairs.extend([
        ...
        ("SHOCK_STRESS_PORTFOLIO_DAILY_LOSS_LIMIT_PCT", SHOCK_STRESS_PORTFOLIO_DAILY_LOSS_LIMIT_PCT),
        ("SHOCK_STRESS_PORTFOLIO_OPEN_LOSS_LIMIT_PCT", SHOCK_STRESS_PORTFOLIO_OPEN_LOSS_LIMIT_PCT),
        ("MARKET_REGIME_GUARD_ENABLED", MARKET_REGIME_GUARD_ENABLED),
        ("MARKET_REGIME_SYMBOL", MARKET_REGIME_SYMBOL),
        ("MARKET_REGIME_TZ", MARKET_REGIME_TZ),
        ("MARKET_REGIME_LOOKBACK_DAYS", MARKET_REGIME_LOOKBACK_DAYS),
        ("MARKET_REGIME_MIN_HISTORY_DAYS", MARKET_REGIME_MIN_HISTORY_DAYS),
        ("MARKET_REGIME_ELEVATED_DRAWDOWN_PCT", MARKET_REGIME_ELEVATED_DRAWDOWN_PCT),
        ("MARKET_REGIME_HIGH_DRAWDOWN_PCT", MARKET_REGIME_HIGH_DRAWDOWN_PCT),
        ("MARKET_REGIME_EXTREME_DRAWDOWN_PCT", MARKET_REGIME_EXTREME_DRAWDOWN_PCT),
        ("MARKET_REGIME_MA_CONFIRM_ENABLED", MARKET_REGIME_MA_CONFIRM_ENABLED),
        ("MARKET_REGIME_MA_SHORT_DAYS", MARKET_REGIME_MA_SHORT_DAYS),
        ("MARKET_REGIME_MA_LONG_DAYS", MARKET_REGIME_MA_LONG_DAYS),
        ("MARKET_REGIME_MA_CONFIRM_TIER", MARKET_REGIME_MA_CONFIRM_TIER),
        ("MARKET_REGIME_LONG_RISK_MULTIPLIER_ELEVATED", MARKET_REGIME_LONG_RISK_MULTIPLIER_ELEVATED),
        ("MARKET_REGIME_LONG_RISK_MULTIPLIER_HIGH", MARKET_REGIME_LONG_RISK_MULTIPLIER_HIGH),
        ("MARKET_REGIME_LONG_RISK_MULTIPLIER_EXTREME", MARKET_REGIME_LONG_RISK_MULTIPLIER_EXTREME),
        ("MARKET_REGIME_MAX_LONG_POSITIONS_ELEVATED", MARKET_REGIME_MAX_LONG_POSITIONS_ELEVATED),
        ("MARKET_REGIME_MAX_LONG_POSITIONS_HIGH", MARKET_REGIME_MAX_LONG_POSITIONS_HIGH),
        ("MARKET_REGIME_MAX_LONG_POSITIONS_EXTREME", MARKET_REGIME_MAX_LONG_POSITIONS_EXTREME),
        ("MARKET_REGIME_SHORT_HEDGE_ENABLED", MARKET_REGIME_SHORT_HEDGE_ENABLED),
        ("MARKET_REGIME_SHORT_HEDGE_MIN_TIER", MARKET_REGIME_SHORT_HEDGE_MIN_TIER),
        ("MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_ELEVATED", MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_ELEVATED),
        ("MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_HIGH", MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_HIGH),
        ("MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_EXTREME", MARKET_REGIME_SHORT_HEDGE_RISK_MULTIPLIER_EXTREME),
        ("MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_ELEVATED", MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_ELEVATED),
        ("MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_HIGH", MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_HIGH),
        ("MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_EXTREME", MARKET_REGIME_SHORT_HEDGE_MAX_POSITIONS_EXTREME),
        ("MARKET_REGIME_GENERATE_HEDGE_ENABLED", MARKET_REGIME_GENERATE_HEDGE_ENABLED),
        ("MARKET_REGIME_HEDGE_SYMBOL", MARKET_REGIME_HEDGE_SYMBOL),
        ("MARKET_REGIME_HEDGE_MIN_TIER", MARKET_REGIME_HEDGE_MIN_TIER),
        ("MARKET_REGIME_HEDGE_INTENT_SCORE", MARKET_REGIME_HEDGE_INTENT_SCORE),
        ("MARKET_REGIME_HEDGE_REQUIRE_BROKER_ELIGIBILITY", MARKET_REGIME_HEDGE_REQUIRE_BROKER_ELIGIBILITY),
        ("MARKET_REGIME_HEDGE_ALLOW_MULTIPLE_POSITIONS", MARKET_REGIME_HEDGE_ALLOW_MULTIPLE_POSITIONS),
        ("PORTFOLIO_DRAWDOWN_CIRCUIT_BREAKER_ENABLED", PORTFOLIO_DRAWDOWN_CIRCUIT_BREAKER_ENABLED),
        ("PORTFOLIO_DRAWDOWN_WARN_PCT", PORTFOLIO_DRAWDOWN_WARN_PCT),
        ("PORTFOLIO_DRAWDOWN_STRESS_PCT", PORTFOLIO_DRAWDOWN_STRESS_PCT),
        ("PORTFOLIO_DRAWDOWN_EXTREME_PCT", PORTFOLIO_DRAWDOWN_EXTREME_PCT),
        ("PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_WARN", PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_WARN),
        ("PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_STRESS", PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_STRESS),
        ("PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_EXTREME", PORTFOLIO_DRAWDOWN_LONG_RISK_MULTIPLIER_EXTREME),
        ("PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_WARN", PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_WARN),
        ("PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_STRESS", PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_STRESS),
        ("PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_EXTREME", PORTFOLIO_DRAWDOWN_MAX_LONG_POSITIONS_EXTREME),
        ("PORTFOLIO_DRAWDOWN_RESET_ON_REGIME_ENABLED", PORTFOLIO_DRAWDOWN_RESET_ON_REGIME_ENABLED),
        ("PORTFOLIO_DRAWDOWN_RESET_REGIME_LABEL", PORTFOLIO_DRAWDOWN_RESET_REGIME_LABEL),
        ("PORTFOLIO_DRAWDOWN_RESET_CONSECUTIVE_DAYS", PORTFOLIO_DRAWDOWN_RESET_CONSECUTIVE_DAYS),
