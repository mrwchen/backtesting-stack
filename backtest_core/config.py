...
DAILY_POLICY_WORLD_REGIME_TREND_DAYS = max(1, env_int("DAILY_POLICY_WORLD_REGIME_TREND_DAYS", 2))
...
DAILY_POLICY_SL_HALT_STATUSES = tuple(env_list(
    ...
    ["HIT_SL", "REGIME_RISK_LONG_HIT_SL", "REGIME_RISK_SHORT_HIT_SL"],
))
...
def _build_run_notes(notes: Optional[str], cfg=None) -> str:
    ...
    pairs: list[tuple[str, object]] = [
        ...
        ("DAILY_POLICY_WORLD_REGIME_TREND_DAYS", DAILY_POLICY_WORLD_REGIME_TREND_DAYS),
