...
EXECUTION_LONG_TP1_PCT = env_float("EXECUTION_LONG_TP1_PCT", 0.055)
EXECUTION_LONG_TP2_PCT = env_float("EXECUTION_LONG_TP2_PCT", 0.12)
EXECUTION_SHORT_TP1_PCT = env_float("EXECUTION_SHORT_TP1_PCT", 0.06)
EXECUTION_SHORT_TP2_PCT = env_float("EXECUTION_SHORT_TP2_PCT", 0.11)
...
EXECUTION_TP1_CLOSE_RATIO = env_float("EXECUTION_TP1_CLOSE_RATIO", 0.6)
for _name, _value in {
    "EXECUTION_LONG_TP1_PCT": EXECUTION_LONG_TP1_PCT,
    "EXECUTION_LONG_TP2_PCT": EXECUTION_LONG_TP2_PCT,
    "EXECUTION_SHORT_TP1_PCT": EXECUTION_SHORT_TP1_PCT,
    "EXECUTION_SHORT_TP2_PCT": EXECUTION_SHORT_TP2_PCT,
    "EXECUTION_LONG_MAX_HOLD_DAYS": EXECUTION_LONG_MAX_HOLD_DAYS,
    "EXECUTION_SHORT_MAX_HOLD_DAYS": EXECUTION_SHORT_MAX_HOLD_DAYS,
    "EXECUTION_TP1_CLOSE_RATIO": EXECUTION_TP1_CLOSE_RATIO,
}.items():
    if _value < 0.0:
        raise ValueError(f"{_name} must be >= 0")
if EXECUTION_LONG_TP2_PCT <= EXECUTION_LONG_TP1_PCT:
    raise ValueError("EXECUTION_LONG_TP2_PCT must be greater than EXECUTION_LONG_TP1_PCT")
if EXECUTION_SHORT_TP2_PCT <= EXECUTION_SHORT_TP1_PCT:
    raise ValueError("EXECUTION_SHORT_TP2_PCT must be greater than EXECUTION_SHORT_TP1_PCT")
if EXECUTION_TP1_CLOSE_RATIO > 1.0:
    raise ValueError("EXECUTION_TP1_CLOSE_RATIO must be <= 1")
