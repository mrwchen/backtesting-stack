...
def write_trades(
    ...
    for t in trades:
        ...
        rows.append((
            ...
            plan.dominant_shock_type or None,
            _decimal_or_none(plan.max_shock_type_score, 2),
            _decimal_or_none(plan.defensive_risk_off_score, 2),
            _decimal_or_none(plan.energy_commodity_shock_score, 2),
            _decimal_or_none(plan.rates_inflation_usd_shock_score, 2),
            _decimal_or_none(plan.credit_banking_stress_score, 2),
            _decimal_or_none(plan.policy_geopolitical_score, 2),
            _decimal_or_none(plan.tech_stress_shock_score, 2),
            _decimal_or_none(plan.precious_metals_score, 2),
            _decimal_or_none(plan.industrial_metals_score, 2),
            _decimal_or_none(plan.metals_mining_shock_score, 2),
            plan.metals_mining_subtype or None,
            _decimal_or_none(plan.shock_sector_bias, 4),
            _decimal_or_none(plan.shock_score_delta, 4),
            _decimal_or_none(plan.shock_risk_multiplier, 4),
            _decimal_or_none(plan.shock_base_intent_score, 4),
    ...
    query = """
        INSERT INTO {table} (
            ...
            dominant_shock_type, max_shock_type_score,
            ...
            precious_metals_score, industrial_metals_score, metals_mining_shock_score, metals_mining_subtype,
            shock_sector_bias, shock_score_delta, shock_risk_multiplier, shock_base_intent_score,
        ...
        ON CONFLICT (run_id, intent_date, symbol, exchange, cik, direction, entry_ts) DO UPDATE SET
            ...
            defensive_risk_off_score = EXCLUDED.defensive_risk_off_score,
            energy_commodity_shock_score = EXCLUDED.energy_commodity_shock_score,
            rates_inflation_usd_shock_score = EXCLUDED.rates_inflation_usd_shock_score,
            credit_banking_stress_score = EXCLUDED.credit_banking_stress_score,
            policy_geopolitical_score = EXCLUDED.policy_geopolitical_score,
            tech_stress_shock_score = EXCLUDED.tech_stress_shock_score,
            precious_metals_score = EXCLUDED.precious_metals_score,
            industrial_metals_score = EXCLUDED.industrial_metals_score,
            metals_mining_shock_score = EXCLUDED.metals_mining_shock_score,
            metals_mining_subtype = EXCLUDED.metals_mining_subtype,
            shock_sector_bias = EXCLUDED.shock_sector_bias,
            shock_score_delta = EXCLUDED.shock_score_delta,
            shock_risk_multiplier = EXCLUDED.shock_risk_multiplier,
...
def write_decision_events(
    ...
    rows = [
        (
            ...
            e.dominant_shock_type or None,
            _decimal_or_none(e.max_shock_type_score, 2),
            _decimal_or_none(e.defensive_risk_off_score, 2),
            _decimal_or_none(e.energy_commodity_shock_score, 2),
            _decimal_or_none(e.rates_inflation_usd_shock_score, 2),
            _decimal_or_none(e.credit_banking_stress_score, 2),
            _decimal_or_none(e.policy_geopolitical_score, 2),
            _decimal_or_none(e.tech_stress_shock_score, 2),
            _decimal_or_none(e.precious_metals_score, 2),
            _decimal_or_none(e.industrial_metals_score, 2),
            _decimal_or_none(e.metals_mining_shock_score, 2),
            e.metals_mining_subtype or None,
            _decimal_or_none(e.shock_sector_bias, 4),
            _decimal_or_none(e.shock_score_delta, 4),
            _decimal_or_none(e.shock_risk_multiplier, 4),
            _decimal_or_none(e.shock_base_intent_score, 4),
