...
EXECUTION_LONG_MAX_HOLD_DAYS = env_float("EXECUTION_LONG_MAX_HOLD_DAYS", 21.0)
EXECUTION_SHORT_MAX_HOLD_DAYS = env_float("EXECUTION_SHORT_MAX_HOLD_DAYS", 7.0)
...
MODEL_FILE = os.getenv("MODEL_FILE", "regime_qqq_relative_strength_v1.py").strip()
...
def _build_run_notes(notes: Optional[str], cfg=None) -> str:
    ...
    pairs.extend([
        ...
        ("REQUIRE_USD_PRICE_DATA", REQUIRE_USD_PRICE_DATA),
    ...
    if ACCOUNT_PROFILE == "ps_acc":
        ...
        pairs.extend([
            ...
            ("IBKR_SHORT_INITIAL_MARGIN_PCT", IBKR_SHORT_INITIAL_MARGIN_PCT),
            ("IBKR_SHORT_MAINTENANCE_MARGIN_PCT", IBKR_SHORT_MAINTENANCE_MARGIN_PCT),
            ("IBKR_SYMBOLS_TABLE", IBKR_SYMBOLS_TABLE),
...
IBKR_SYMBOLS_TABLE = os.getenv(
    "IBKR_SYMBOLS_TABLE",
    "public.ibkr_symbols",
)
REQUIRE_USD_PRICE_DATA = env_bool("REQUIRE_USD_PRICE_DATA", True)
