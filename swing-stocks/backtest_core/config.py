...
RISK_PER_TRADE_PCT     = float(os.getenv("RISK_PER_TRADE_EQUITY_PCT", "1.5"))
MAX_OPEN_POSITIONS     = int(os.getenv("MAX_OPEN_POSITIONS", "5"))
MAX_POSITION_OPENS_PER_DAY = env_int("MAX_POSITION_OPENS_PER_DAY", 2)
...
DAILY_POLICY_TZ = env_str("DAILY_POLICY_TZ", "America/New_York")
DAILY_POLICY_WORLD_REGIME_MA_DAYS = max(1, env_int("DAILY_POLICY_WORLD_REGIME_MA_DAYS", 5))
DAILY_POLICY_WORLD_REGIME_STRESS_BUILDING_TREND_DAYS = max(
    1,
    env_int("DAILY_POLICY_WORLD_REGIME_STRESS_BUILDING_TREND_DAYS", 2),
)
DAILY_POLICY_WORLD_REGIME_STRESS_RECEDING_TREND_DAYS = max(
    1,
    env_int("DAILY_POLICY_WORLD_REGIME_STRESS_RECEDING_TREND_DAYS", 2),
)
DAILY_POLICY_WORLD_REGIME_STRESS_THRESHOLD = env_float("DAILY_POLICY_WORLD_REGIME_STRESS_THRESHOLD", 45.0)
DAILY_POLICY_WORLD_REGIME_HIGH_STRESS_THRESHOLD = env_float("DAILY_POLICY_WORLD_REGIME_HIGH_STRESS_THRESHOLD", 60.0)
DAILY_POLICY_LOW_STRESS_MAX_LONG_POSITIONS = env_int("DAILY_POLICY_LOW_STRESS_MAX_LONG_POSITIONS", 5)
DAILY_POLICY_LOW_STRESS_MAX_SHORT_POSITIONS = env_int("DAILY_POLICY_LOW_STRESS_MAX_SHORT_POSITIONS", 0)
DAILY_POLICY_INITIAL_PREVIOUS_MAX_LONG_POSITIONS = env_int("DAILY_POLICY_INITIAL_PREVIOUS_MAX_LONG_POSITIONS", 5)
DAILY_POLICY_STRESS_RISK_REDUCTION_PCT = env_float("DAILY_POLICY_STRESS_RISK_REDUCTION_PCT", 0.5)
DAILY_POLICY_STRESS_BUILD_MAX_LONG_DELTA = env_int("DAILY_POLICY_STRESS_BUILD_MAX_LONG_DELTA", -1)
DAILY_POLICY_STRESS_RECOVERY_MAX_LONG_DELTA = env_int("DAILY_POLICY_STRESS_RECOVERY_MAX_LONG_DELTA", 1)
DAILY_POLICY_STRESS_SIDEWAYS_MAX_LONG_DELTA = env_int("DAILY_POLICY_STRESS_SIDEWAYS_MAX_LONG_DELTA", 0)
DAILY_POLICY_STRESS_BUILD_MAX_SHORT_POSITIONS = env_int("DAILY_POLICY_STRESS_BUILD_MAX_SHORT_POSITIONS", 0)
DAILY_POLICY_STRESS_RECOVERY_MAX_SHORT_POSITIONS = env_int("DAILY_POLICY_STRESS_RECOVERY_MAX_SHORT_POSITIONS", 0)
DAILY_POLICY_STRESS_SIDEWAYS_MAX_SHORT_POSITIONS = env_int("DAILY_POLICY_STRESS_SIDEWAYS_MAX_SHORT_POSITIONS", 0)
DAILY_POLICY_SHORT_RISK_MULTIPLIER = env_float("DAILY_POLICY_SHORT_RISK_MULTIPLIER", 1.0)
DAILY_POLICY_HIGH_STRESS_MAX_LONG_POSITIONS = env_int("DAILY_POLICY_HIGH_STRESS_MAX_LONG_POSITIONS", 0)
DAILY_POLICY_HIGH_STRESS_MAX_SHORT_POSITIONS = env_int("DAILY_POLICY_HIGH_STRESS_MAX_SHORT_POSITIONS", 2)
DAILY_POLICY_MIN_HOURS_BETWEEN_OPENS = env_float("DAILY_POLICY_MIN_HOURS_BETWEEN_OPENS", 3.0)
DAILY_POLICY_SL_HALT_WINDOW_HOURS = env_float("DAILY_POLICY_SL_HALT_WINDOW_HOURS", 2.0)
DAILY_POLICY_SL_HALT_COUNT = env_int("DAILY_POLICY_SL_HALT_COUNT", 3)
DAILY_POLICY_SL_HALT_STATUSES = tuple(env_list(
    "DAILY_POLICY_SL_HALT_STATUSES",
    ["HIT_SL"],
))
DAILY_POLICY_PORTFOLIO_DROP_LOOKBACK_DAYS = max(0, env_int("DAILY_POLICY_PORTFOLIO_DROP_LOOKBACK_DAYS", 2))
DAILY_POLICY_PORTFOLIO_DROP_THRESHOLD_PCT = env_float("DAILY_POLICY_PORTFOLIO_DROP_THRESHOLD_PCT", 5.0)
DAILY_POLICY_MARKET_DROP_SYMBOL = env_str("DAILY_POLICY_MARKET_DROP_SYMBOL", "VOO").upper()
DAILY_POLICY_MARKET_DROP_THRESHOLD_PCT = env_float("DAILY_POLICY_MARKET_DROP_THRESHOLD_PCT", 3.5)
DAILY_POLICY_MARKET_DROP_TZ = env_str("DAILY_POLICY_MARKET_DROP_TZ", "America/New_York")
DAILY_POLICY_MARKET_DROP_SESSION_START = env_str("DAILY_POLICY_MARKET_DROP_SESSION_START", "09:30")
DAILY_POLICY_MARKET_DROP_SESSION_END = env_str("DAILY_POLICY_MARKET_DROP_SESSION_END", "16:00")
DAILY_POLICY_MARKET_DROP_OPEN_BAR_MODE = env_str("DAILY_POLICY_MARKET_DROP_OPEN_BAR_MODE", "at_or_after")
DAILY_POLICY_MARKET_DROP_PRICE_FIELD = env_str("DAILY_POLICY_MARKET_DROP_PRICE_FIELD", "low").lower()
DAILY_POLICY_PREVIOUS_MARKET_DROP_SYMBOL = env_str(
    "DAILY_POLICY_PREVIOUS_MARKET_DROP_SYMBOL",
    DAILY_POLICY_MARKET_DROP_SYMBOL,
).upper()
DAILY_POLICY_PREVIOUS_MARKET_DROP_THRESHOLD_PCT = env_float(
    "DAILY_POLICY_PREVIOUS_MARKET_DROP_THRESHOLD_PCT",
    4.0,
)
DAILY_POLICY_PREVIOUS_MARKET_DROP_PRICE_FIELD = env_str(
    "DAILY_POLICY_PREVIOUS_MARKET_DROP_PRICE_FIELD",
    "close",
).lower()
DAILY_POLICY_PRUNE_ENABLED = env_bool("DAILY_POLICY_PRUNE_ENABLED", True)
DAILY_POLICY_PRUNE_TIME_TZ = env_str("DAILY_POLICY_PRUNE_TIME_TZ", "America/New_York")
DAILY_POLICY_PRUNE_TIME = env_str("DAILY_POLICY_PRUNE_TIME", "11:00")
DAILY_POLICY_TECH_STRESS_LOOKBACK_DAYS = max(1, env_int("DAILY_POLICY_TECH_STRESS_LOOKBACK_DAYS", 3))
DAILY_POLICY_TECH_STRESS_THRESHOLD = env_float("DAILY_POLICY_TECH_STRESS_THRESHOLD", 60.0)
DAILY_POLICY_BLOCK_LONG_SECTOR = env_str("DAILY_POLICY_BLOCK_LONG_SECTOR", "Technology")
DAILY_POLICY_ENERGY_SHOCK_LOOKBACK_DAYS = max(1, env_int("DAILY_POLICY_ENERGY_SHOCK_LOOKBACK_DAYS", 3))
DAILY_POLICY_ENERGY_SHOCK_THRESHOLD = env_float("DAILY_POLICY_ENERGY_SHOCK_THRESHOLD", 60.0)
DAILY_POLICY_PREFERRED_INDUSTRY = env_str("DAILY_POLICY_PREFERRED_INDUSTRY", "Oil & Gas Integrated")
DAILY_POLICY_LOOKBACK_CALENDAR_DAYS = max(10, env_int("DAILY_POLICY_LOOKBACK_CALENDAR_DAYS", 45))
if DAILY_POLICY_LOW_STRESS_MAX_LONG_POSITIONS < 0:
    raise ValueError("DAILY_POLICY_LOW_STRESS_MAX_LONG_POSITIONS must be >= 0")
if DAILY_POLICY_LOW_STRESS_MAX_SHORT_POSITIONS < 0:
    raise ValueError("DAILY_POLICY_LOW_STRESS_MAX_SHORT_POSITIONS must be >= 0")
if DAILY_POLICY_INITIAL_PREVIOUS_MAX_LONG_POSITIONS < 0:
    raise ValueError("DAILY_POLICY_INITIAL_PREVIOUS_MAX_LONG_POSITIONS must be >= 0")
if DAILY_POLICY_HIGH_STRESS_MAX_LONG_POSITIONS < 0:
    raise ValueError("DAILY_POLICY_HIGH_STRESS_MAX_LONG_POSITIONS must be >= 0")
if DAILY_POLICY_HIGH_STRESS_MAX_SHORT_POSITIONS < 0:
    raise ValueError("DAILY_POLICY_HIGH_STRESS_MAX_SHORT_POSITIONS must be >= 0")
if DAILY_POLICY_STRESS_RISK_REDUCTION_PCT < 0.0:
    raise ValueError("DAILY_POLICY_STRESS_RISK_REDUCTION_PCT must be >= 0")
if DAILY_POLICY_STRESS_BUILD_MAX_SHORT_POSITIONS < 0:
    raise ValueError("DAILY_POLICY_STRESS_BUILD_MAX_SHORT_POSITIONS must be >= 0")
if DAILY_POLICY_STRESS_RECOVERY_MAX_SHORT_POSITIONS < 0:
    raise ValueError("DAILY_POLICY_STRESS_RECOVERY_MAX_SHORT_POSITIONS must be >= 0")
if DAILY_POLICY_STRESS_SIDEWAYS_MAX_SHORT_POSITIONS < 0:
    raise ValueError("DAILY_POLICY_STRESS_SIDEWAYS_MAX_SHORT_POSITIONS must be >= 0")
if DAILY_POLICY_SHORT_RISK_MULTIPLIER < 0.0:
    raise ValueError("DAILY_POLICY_SHORT_RISK_MULTIPLIER must be >= 0")
if DAILY_POLICY_MIN_HOURS_BETWEEN_OPENS < 0.0:
    raise ValueError("DAILY_POLICY_MIN_HOURS_BETWEEN_OPENS must be >= 0")
if DAILY_POLICY_SL_HALT_WINDOW_HOURS <= 0.0:
    raise ValueError("DAILY_POLICY_SL_HALT_WINDOW_HOURS must be > 0")
if DAILY_POLICY_SL_HALT_COUNT < 1:
    raise ValueError("DAILY_POLICY_SL_HALT_COUNT must be >= 1")
if DAILY_POLICY_PORTFOLIO_DROP_THRESHOLD_PCT < 0.0:
    raise ValueError("DAILY_POLICY_PORTFOLIO_DROP_THRESHOLD_PCT must be >= 0")
if DAILY_POLICY_MARKET_DROP_THRESHOLD_PCT < 0.0:
    raise ValueError("DAILY_POLICY_MARKET_DROP_THRESHOLD_PCT must be >= 0")
if DAILY_POLICY_PREVIOUS_MARKET_DROP_THRESHOLD_PCT < 0.0:
    raise ValueError("DAILY_POLICY_PREVIOUS_MARKET_DROP_THRESHOLD_PCT must be >= 0")
if DAILY_POLICY_MARKET_DROP_OPEN_BAR_MODE not in {"at_or_after", "containing"}:
    raise ValueError("DAILY_POLICY_MARKET_DROP_OPEN_BAR_MODE must be one of: at_or_after, containing")
if DAILY_POLICY_MARKET_DROP_PRICE_FIELD not in {"low", "close"}:
    raise ValueError("DAILY_POLICY_MARKET_DROP_PRICE_FIELD must be one of: low, close")
if DAILY_POLICY_PREVIOUS_MARKET_DROP_PRICE_FIELD not in {"low", "close"}:
    raise ValueError("DAILY_POLICY_PREVIOUS_MARKET_DROP_PRICE_FIELD must be one of: low, close")
INTENT_SCORE_CLUSTERING_ENABLED = env_bool("INTENT_SCORE_CLUSTERING_ENABLED", False)
INTENT_SCORE_CLUSTER_DELTA = env_float("INTENT_SCORE_CLUSTER_DELTA", 0.25)
INTENT_SCORE_CLUSTER_MIN_SIZE = env_int("INTENT_SCORE_CLUSTER_MIN_SIZE", 2)
INTENT_SCORE_CLUSTER_RANDOM_SEED = env_int("INTENT_SCORE_CLUSTER_RANDOM_SEED", 12345)
if INTENT_SCORE_CLUSTER_DELTA < 0.0:
    raise ValueError("INTENT_SCORE_CLUSTER_DELTA must be >= 0")
if INTENT_SCORE_CLUSTER_MIN_SIZE < 1:
    raise ValueError("INTENT_SCORE_CLUSTER_MIN_SIZE must be >= 1")
...
COMMON_FILTER_SCORER_ELIGIBILITY = env_bool("COMMON_FILTER_SCORER_ELIGIBILITY", False)
COMMON_REQUIRE_UPCOMING_EARNINGS_DATE = env_bool("COMMON_REQUIRE_UPCOMING_EARNINGS_DATE", False)
COMMON_REQUIRE_UPCOMING_EARNINGS_DATE_DAYS = env_int("COMMON_REQUIRE_UPCOMING_EARNINGS_DATE_DAYS", 100)
COMMON_EARNINGS_BLACKOUT_ENABLED = env_bool("COMMON_EARNINGS_BLACKOUT_ENABLED", False)
COMMON_EARNINGS_BLACKOUT_DAYS = env_int("COMMON_EARNINGS_BLACKOUT_DAYS", 14)
COMMON_HISTORICAL_EARNINGS_KNOWN_DAYS_BEFORE = env_int("COMMON_HISTORICAL_EARNINGS_KNOWN_DAYS_BEFORE", 21)
for _name, _value in {
...
if COMMON_EARNINGS_BLACKOUT_DAYS < 0:
    raise ValueError("COMMON_EARNINGS_BLACKOUT_DAYS must be >= 0")
if COMMON_REQUIRE_UPCOMING_EARNINGS_DATE_DAYS < 0:
    raise ValueError("COMMON_REQUIRE_UPCOMING_EARNINGS_DATE_DAYS must be >= 0")
if COMMON_HISTORICAL_EARNINGS_KNOWN_DAYS_BEFORE < 0:
    raise ValueError("COMMON_HISTORICAL_EARNINGS_KNOWN_DAYS_BEFORE must be >= 0")
SECTOR_DIVERSIFICATION_ENABLED = env_bool("SECTOR_DIVERSIFICATION_ENABLED", False)

WORLD_REGIME_SHOCK_FIELDS_ACTIVE = True
...
FUNDAMENTAL_RELATIVE_SCORE_ONLY = env_bool("FUNDAMENTAL_RELATIVE_SCORE_ONLY", False)
...
def _build_run_notes(notes: Optional[str], cfg=None) -> str:
    ...
    pairs: list[tuple[str, object]] = [
        ...
        ("FUNDAMENTAL_RELATIVE_SCORE_ONLY", FUNDAMENTAL_RELATIVE_SCORE_ONLY),
        ...
        ("DAILY_POLICY_TZ", DAILY_POLICY_TZ),
        ("DAILY_POLICY_WORLD_REGIME_MA_DAYS", DAILY_POLICY_WORLD_REGIME_MA_DAYS),
        (
        ...
        ("DAILY_POLICY_WORLD_REGIME_STRESS_THRESHOLD", DAILY_POLICY_WORLD_REGIME_STRESS_THRESHOLD),
        ("DAILY_POLICY_WORLD_REGIME_HIGH_STRESS_THRESHOLD", DAILY_POLICY_WORLD_REGIME_HIGH_STRESS_THRESHOLD),
        ("DAILY_POLICY_LOW_STRESS_MAX_LONG_POSITIONS", DAILY_POLICY_LOW_STRESS_MAX_LONG_POSITIONS),
        ("DAILY_POLICY_LOW_STRESS_MAX_SHORT_POSITIONS", DAILY_POLICY_LOW_STRESS_MAX_SHORT_POSITIONS),
        ("DAILY_POLICY_INITIAL_PREVIOUS_MAX_LONG_POSITIONS", DAILY_POLICY_INITIAL_PREVIOUS_MAX_LONG_POSITIONS),
        ("DAILY_POLICY_STRESS_RISK_REDUCTION_PCT", DAILY_POLICY_STRESS_RISK_REDUCTION_PCT),
        ("DAILY_POLICY_STRESS_BUILD_MAX_LONG_DELTA", DAILY_POLICY_STRESS_BUILD_MAX_LONG_DELTA),
        ("DAILY_POLICY_STRESS_RECOVERY_MAX_LONG_DELTA", DAILY_POLICY_STRESS_RECOVERY_MAX_LONG_DELTA),
        ("DAILY_POLICY_STRESS_SIDEWAYS_MAX_LONG_DELTA", DAILY_POLICY_STRESS_SIDEWAYS_MAX_LONG_DELTA),
        ("DAILY_POLICY_STRESS_BUILD_MAX_SHORT_POSITIONS", DAILY_POLICY_STRESS_BUILD_MAX_SHORT_POSITIONS),
        ("DAILY_POLICY_STRESS_RECOVERY_MAX_SHORT_POSITIONS", DAILY_POLICY_STRESS_RECOVERY_MAX_SHORT_POSITIONS),
        ("DAILY_POLICY_STRESS_SIDEWAYS_MAX_SHORT_POSITIONS", DAILY_POLICY_STRESS_SIDEWAYS_MAX_SHORT_POSITIONS),
        ("DAILY_POLICY_SHORT_RISK_MULTIPLIER", DAILY_POLICY_SHORT_RISK_MULTIPLIER),
        ("DAILY_POLICY_HIGH_STRESS_MAX_LONG_POSITIONS", DAILY_POLICY_HIGH_STRESS_MAX_LONG_POSITIONS),
        ("DAILY_POLICY_HIGH_STRESS_MAX_SHORT_POSITIONS", DAILY_POLICY_HIGH_STRESS_MAX_SHORT_POSITIONS),
        ("DAILY_POLICY_MIN_HOURS_BETWEEN_OPENS", DAILY_POLICY_MIN_HOURS_BETWEEN_OPENS),
        ("DAILY_POLICY_SL_HALT_WINDOW_HOURS", DAILY_POLICY_SL_HALT_WINDOW_HOURS),
        ("DAILY_POLICY_SL_HALT_COUNT", DAILY_POLICY_SL_HALT_COUNT),
        ("DAILY_POLICY_SL_HALT_STATUSES", DAILY_POLICY_SL_HALT_STATUSES),
        ("DAILY_POLICY_PORTFOLIO_DROP_LOOKBACK_DAYS", DAILY_POLICY_PORTFOLIO_DROP_LOOKBACK_DAYS),
        ("DAILY_POLICY_PORTFOLIO_DROP_THRESHOLD_PCT", DAILY_POLICY_PORTFOLIO_DROP_THRESHOLD_PCT),
        ("DAILY_POLICY_MARKET_DROP_SYMBOL", DAILY_POLICY_MARKET_DROP_SYMBOL),
        ("DAILY_POLICY_MARKET_DROP_THRESHOLD_PCT", DAILY_POLICY_MARKET_DROP_THRESHOLD_PCT),
        ("DAILY_POLICY_MARKET_DROP_TZ", DAILY_POLICY_MARKET_DROP_TZ),
        ("DAILY_POLICY_MARKET_DROP_SESSION_START", DAILY_POLICY_MARKET_DROP_SESSION_START),
        ("DAILY_POLICY_MARKET_DROP_SESSION_END", DAILY_POLICY_MARKET_DROP_SESSION_END),
        ("DAILY_POLICY_MARKET_DROP_OPEN_BAR_MODE", DAILY_POLICY_MARKET_DROP_OPEN_BAR_MODE),
        ("DAILY_POLICY_MARKET_DROP_PRICE_FIELD", DAILY_POLICY_MARKET_DROP_PRICE_FIELD),
        ("DAILY_POLICY_PREVIOUS_MARKET_DROP_SYMBOL", DAILY_POLICY_PREVIOUS_MARKET_DROP_SYMBOL),
        ("DAILY_POLICY_PREVIOUS_MARKET_DROP_THRESHOLD_PCT", DAILY_POLICY_PREVIOUS_MARKET_DROP_THRESHOLD_PCT),
        ("DAILY_POLICY_PREVIOUS_MARKET_DROP_PRICE_FIELD", DAILY_POLICY_PREVIOUS_MARKET_DROP_PRICE_FIELD),
        ("DAILY_POLICY_PRUNE_ENABLED", DAILY_POLICY_PRUNE_ENABLED),
        ("DAILY_POLICY_PRUNE_TIME_TZ", DAILY_POLICY_PRUNE_TIME_TZ),
        ("DAILY_POLICY_PRUNE_TIME", DAILY_POLICY_PRUNE_TIME),
        ("DAILY_POLICY_TECH_STRESS_LOOKBACK_DAYS", DAILY_POLICY_TECH_STRESS_LOOKBACK_DAYS),
        ("DAILY_POLICY_TECH_STRESS_THRESHOLD", DAILY_POLICY_TECH_STRESS_THRESHOLD),
        ("DAILY_POLICY_BLOCK_LONG_SECTOR", DAILY_POLICY_BLOCK_LONG_SECTOR),
        ("DAILY_POLICY_ENERGY_SHOCK_LOOKBACK_DAYS", DAILY_POLICY_ENERGY_SHOCK_LOOKBACK_DAYS),
        ("DAILY_POLICY_ENERGY_SHOCK_THRESHOLD", DAILY_POLICY_ENERGY_SHOCK_THRESHOLD),
        ("DAILY_POLICY_PREFERRED_INDUSTRY", DAILY_POLICY_PREFERRED_INDUSTRY),
        ("DAILY_POLICY_LOOKBACK_CALENDAR_DAYS", DAILY_POLICY_LOOKBACK_CALENDAR_DAYS),
        ("INTENT_SCORE_CLUSTERING_ENABLED", INTENT_SCORE_CLUSTERING_ENABLED),
        ("INTENT_SCORE_CLUSTER_DELTA", INTENT_SCORE_CLUSTER_DELTA),
        ("INTENT_SCORE_CLUSTER_MIN_SIZE", INTENT_SCORE_CLUSTER_MIN_SIZE),
        ("INTENT_SCORE_CLUSTER_RANDOM_SEED", INTENT_SCORE_CLUSTER_RANDOM_SEED),
    ]
    if suffix:
    ...
    pairs.extend([
        ...
        ("SOURCE_EARNINGS_CALENDAR_EVENTS_TABLE", SOURCE_EARNINGS_CALENDAR_EVENTS_TABLE),
    ...
    pairs.extend([
        ...
        ("COMMON_FILTER_SCORER_ELIGIBILITY", COMMON_FILTER_SCORER_ELIGIBILITY),
        ("COMMON_REQUIRE_UPCOMING_EARNINGS_DATE", COMMON_REQUIRE_UPCOMING_EARNINGS_DATE),
        ("COMMON_REQUIRE_UPCOMING_EARNINGS_DATE_DAYS", COMMON_REQUIRE_UPCOMING_EARNINGS_DATE_DAYS),
        ("COMMON_EARNINGS_BLACKOUT_ENABLED", COMMON_EARNINGS_BLACKOUT_ENABLED),
        ("COMMON_EARNINGS_BLACKOUT_DAYS", COMMON_EARNINGS_BLACKOUT_DAYS),
        ("COMMON_HISTORICAL_EARNINGS_KNOWN_DAYS_BEFORE", COMMON_HISTORICAL_EARNINGS_KNOWN_DAYS_BEFORE),
...
SOURCE_EARNINGS_CALENDAR_EVENTS_TABLE = os.getenv(
...
BACKTEST_WORKER_DB_RETRY_ATTEMPTS = max(1, env_int("BACKTEST_WORKER_DB_RETRY_ATTEMPTS", 2))
BACKTEST_WORKER_DB_RETRY_DELAY_SECONDS = max(0.0, env_float("BACKTEST_WORKER_DB_RETRY_DELAY_SECONDS", 10.0))
