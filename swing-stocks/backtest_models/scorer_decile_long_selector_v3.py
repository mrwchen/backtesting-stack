"""V3 long-only scorer selector.

V3 keeps the v2 overextension filters and adds defensive portfolio behavior:
  - no new entries in configured stress regimes,
  - active exits for weak/flat positions when those regimes appear,
  - earlier MFE-fade protection,
  - a higher minimum intent score.
"""
...
MODEL_NAME = "scorer_decile_long_selector_v3"
