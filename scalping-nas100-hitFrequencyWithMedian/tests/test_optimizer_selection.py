...
def _values(**overrides):
    values = {
        ...
        "ENTRY_PRICE_RANGE_POSITION_MAX_DEVIATION_PCT": 15.0,
        "ALL_STOP_MODES_TAKE_PROFIT_ATR_MULT": 10.0,
        "BAND_STOP_MIN_PROFILE_RANGE_ATR_MULT": 20.0,
        "BAND_STOP_PROFILE_LOWER_QUANTILE": 0.05,
        "BAND_STOP_PROFILE_UPPER_QUANTILE": 0.95,
        "BAND_STOP_PROFILE_BUFFER_POINTS": 1.0,
        "BAND_STOP_MIN_DISTANCE_ATR_MULT": 6.0,
        "BAND_STOP_MAX_DISTANCE_ATR_MULT": 15.0,
    }
