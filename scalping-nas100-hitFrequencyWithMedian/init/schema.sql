...
CREATE TABLE IF NOT EXISTS backtest2_nas100_hfmed_runs (
    ...
    baseline_entry_price_range_position_max_deviation_pct NUMERIC(8,4) NOT NULL,
    stop_mode                           TEXT          NOT NULL,
    baseline_stop_points                NUMERIC(12,4) NOT NULL,
    baseline_take_profit_atr_mult       NUMERIC(12,6) NOT NULL,
    baseline_min_profile_range_atr_mult NUMERIC(12,6) NOT NULL,
    ...
    baseline_min_stop_distance_atr_mult NUMERIC(12,6) NOT NULL,
    baseline_max_stop_distance_atr_mult NUMERIC(12,6) NOT NULL,
...
CREATE TABLE IF NOT EXISTS backtest2_nas100_hfmed_parameter_sets (
    ...
    entry_price_range_position_max_deviation_pct NUMERIC(8,4) NOT NULL,
    take_profit_atr_mult                NUMERIC(12,6) NOT NULL,
    min_profile_range_atr_mult          NUMERIC(12,6) NOT NULL,
    ...
    min_stop_distance_atr_mult          NUMERIC(12,6) NOT NULL,
    max_stop_distance_atr_mult          NUMERIC(12,6) NOT NULL,
...
CREATE TABLE IF NOT EXISTS backtest2_nas100_hfmed_fold_results (
    ...
    rejected_price_range_position       BIGINT,
...
CREATE TABLE IF NOT EXISTS backtest2_nas100_hfmed_trades (
    ...
    profile_low                         NUMERIC(15,4),
    profile_high                        NUMERIC(15,4),
    profile_range                       NUMERIC(12,4),
    cross_price_range_position_pct      NUMERIC(8,4),
    entry_price_range_position_pct      NUMERIC(8,4),
    range_position_deviation_pct        NUMERIC(8,4),
