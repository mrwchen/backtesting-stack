...
CREATE TABLE IF NOT EXISTS backtest2_nas100_hfmed_runs (
    ...
    baseline_take_profit_bps            NUMERIC(12,6) NOT NULL,
    baseline_min_profile_range_bps      NUMERIC(12,6) NOT NULL,
    ...
    baseline_min_stop_distance_bps      NUMERIC(12,6) NOT NULL,
    baseline_max_stop_distance_bps      NUMERIC(12,6) NOT NULL,
...
CREATE TABLE IF NOT EXISTS backtest2_nas100_hfmed_parameter_sets (
    ...
    take_profit_bps                     NUMERIC(12,6) NOT NULL,
    min_profile_range_bps               NUMERIC(12,6) NOT NULL,
    ...
    min_stop_distance_bps               NUMERIC(12,6) NOT NULL,
    max_stop_distance_bps               NUMERIC(12,6) NOT NULL,
