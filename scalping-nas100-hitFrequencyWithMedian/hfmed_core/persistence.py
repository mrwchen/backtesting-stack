...
def create_run(
    ...
    columns = {
        ...
        "baseline_take_profit_atr_mult": cfg.take_profit_atr_mult,
        "baseline_min_profile_range_atr_mult": cfg.min_profile_range_atr_mult,
        ...
        "baseline_min_stop_distance_atr_mult": cfg.min_stop_distance_atr_mult,
        "baseline_max_stop_distance_atr_mult": cfg.max_stop_distance_atr_mult,
...
def insert_parameter_sets(conn, run_id: int, aggregates: list[dict]) -> dict[str, int]:
    ...
    for item in aggregates:
        ...
        row = [
            ...
            values["ALL_STOP_MODES_TAKE_PROFIT_ATR_MULT"],
            values["BAND_STOP_MIN_PROFILE_RANGE_ATR_MULT"],
            values["BAND_STOP_PROFILE_LOWER_QUANTILE"],
            values["BAND_STOP_PROFILE_UPPER_QUANTILE"],
            values["BAND_STOP_PROFILE_BUFFER_POINTS"],
            values["BAND_STOP_MIN_DISTANCE_ATR_MULT"],
            values["BAND_STOP_MAX_DISTANCE_ATR_MULT"],
            item["pre_mc_score"],
            item["score"],
            item["mc_scored"],
