...
def create_run(
    ...
    columns = {
        ...
        "baseline_take_profit_bps": cfg.take_profit_bps,
        "baseline_min_profile_range_bps": cfg.min_profile_range_bps,
        ...
        "baseline_min_stop_distance_bps": cfg.min_stop_distance_bps,
        "baseline_max_stop_distance_bps": cfg.max_stop_distance_bps,
...
def insert_parameter_sets(conn, run_id: int, aggregates: list[dict]) -> dict[str, int]:
    ...
    for item in aggregates:
        ...
        row = [
            ...
            values["ALL_STOP_MODES_TAKE_PROFIT_BPS"],
            values["BAND_STOP_MIN_PROFILE_RANGE_BPS"],
            values["BAND_STOP_PROFILE_LOWER_QUANTILE"],
            values["BAND_STOP_PROFILE_UPPER_QUANTILE"],
            values["BAND_STOP_PROFILE_BUFFER_POINTS"],
            values["BAND_STOP_MIN_DISTANCE_BPS"],
            values["BAND_STOP_MAX_DISTANCE_BPS"],
            item["pre_mc_score"],
            item["score"],
            item["mc_scored"],
