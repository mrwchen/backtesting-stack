...
class SignalConfig:
    ...
    long_min_fundamental: float = 70.0
    short_max_fundamental: float = 35.0
    min_bars: int = 160
...
def iter_grid_search_configs(base_cfg, parse_grid_vals, parse_hold_grid_vals, long_max_hold_days, short_max_hold_days, tp1_close_ratio):
    yield {"config": dataclasses.replace(base_cfg), "long_max_hold_days": long_max_hold_days, "short_max_hold_days": short_max_hold_days, "tp1_close_ratio": tp1_close_ratio, "notes": "grid model=filing_aware_fundamental_momentum_v1", "summary": {}}
