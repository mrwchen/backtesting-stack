...
CREATE TABLE IF NOT EXISTS backtest_momentum_signals (
    ...
    prior_10d_observation_count                SMALLINT NOT NULL,
    prior_10d_max_adjusted_high                NUMERIC(20,8),
    prior_10d_limit_adjusted_price             NUMERIC(20,8),
    ...
    CHECK (currency = 'USD'),
    CHECK (prior_10d_observation_count BETWEEN 0 AND 10),
