...
CREATE TABLE IF NOT EXISTS backtest_account_curve (
    ...
    gross_notional_usd   NUMERIC(15,2) NOT NULL DEFAULT 0,
    long_notional_usd    NUMERIC(15,2) NOT NULL DEFAULT 0,
    short_notional_usd   NUMERIC(15,2) NOT NULL DEFAULT 0,
    net_notional_usd     NUMERIC(15,2) NOT NULL DEFAULT 0,
    gross_exposure_pct   NUMERIC(12,4),
    net_exposure_pct     NUMERIC(12,4),
    margin_level_pct     NUMERIC(12,4),
    position_budget_utilization_pct NUMERIC(12,4),
    total_open_cash_risk_usd NUMERIC(15,2) NOT NULL DEFAULT 0,
    total_open_cash_risk_pct NUMERIC(12,4),
    largest_position_weight_pct NUMERIC(12,4),
