...
def load_config() -> Config:
    ...
    log.info(
        ...
        "pos_frac=%.4f risk_frac=%.4f rr=%.2f lot_step=%.2f regime_validity_min=%.1f "
        "atr_period=%d atr_multiplier=%.2f max_bars_held=%d use_dynamic_spread=%s start=%s end=%s",
        ...
        cfg.max_bars_held, cfg.use_dynamic_spread, cfg.start_time_utc, cfg.end_time_utc,
    )
    return cfg
